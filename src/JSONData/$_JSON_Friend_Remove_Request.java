...
public class $_JSON_Friend_Remove_Request extends $_JSON_Friend_Response {
    public $_JSON_Friend_Remove_Request(String type, String idReceived,  String Id_user,String user_friend_request) {
